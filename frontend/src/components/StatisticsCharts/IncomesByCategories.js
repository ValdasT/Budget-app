...
const ExpensesByCategory = () => {
    ...
    let [allIncomesByCategory, setAllIncomesByCategory] = useState([]);
    ...
    let prepareChartData = allExpenses => {
        ...
        setAllIncomesByCategory(expensesByCategories);
    };

    const data = [];
    allIncomesByCategory.forEach(element => {
